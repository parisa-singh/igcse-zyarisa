# Resources — IGCSE Site (canonical source)

> This file is the **single source of truth** for every resource used on `resources.html`
> and the subject pages. When resources change, update THIS file first, then propagate to
> the HTML. All links verified July 2026.
>
> **Rendering rules** (used on the site):
> - Tables use the `.resource-table` component (columns: Resource · Type · Access · Subjects · Notes).
> - Resource names are hyperlinks.
> - Access is a badge/pill: **green = Free**, **amber = Freemium**, **red = Paid**.
> - Rows sorted: Free → Freemium → Paid.
> - Subject pages show only the rows relevant to that subject.
>
> **Access labels:** Free = fully usable at no cost (free sign-up ok). Freemium = meaningful
> free tier, paid unlocks more. Paid = payment required, no useful free tier.
...
## Past Paper Archives (all 9 subjects)

| Resource | URL | Access | Notes |
|---|---|---|---|
| PapaCambridge | https://pastpapers.papacambridge.com/ | Free | The most complete archive. Question papers, mark schemes, examiner reports by subject and session. Start here. |
| RevisionTown | https://revisiontown.com/cambridge-igcse-past-papers/ | Free | Papers sorted by topic — useful to practise one chapter rather than a full paper. |
| Skolatis / IGCSE Centre | https://skolatis.com/cambridge-igcse-past-exam-papers/ | Free | Good backup if PapaCambridge is missing a session. Also hosts syllabuses. Updated to June 2025 series. |
| PapersDaddy | https://www.papersdaddy.com/cambridge | Free | Topical question sorting and worked solutions for select subjects. Archive spans 2002–2026. |

---

## Revision Notes & Study Platforms
...
| r/IGCSE (Reddit) | https://www.reddit.com/r/igcse/ | Free | All subjects | Active community of current/recent students. Megathreads have subject-specific recs. Honest advice. |
| Save My Exams — IGCSE | https://www.savemyexams.com/igcse/ | Freemium | Physics, Business, Economics, CS, English Language, English Literature, Maths (0607) | Syllabus-mapped notes and questions. Much is free; full access ~£7–9/mo. Has 0607 Core & Extended. |
| Flyp Academy (Psychology) | https://flyp.academy/igcse-revision/psychology | Freemium | Psychology (0980) | Video lessons, notes, quizzes for 0980. One of very few platforms targeting this subject. Some free; full paid. |
| Quizlet IGCSE | https://quizlet.com/subject/igcse/ | Freemium | All subjects | Community flashcard sets. Free to study; some modes paid. Quality varies — check upvotes and syllabus match. |

---

## YouTube — General Study Skills & Motivation

| Resource | URL | Access | Notes |
|---|---|---|---|
| Ali Abdaal — "How to Study for Exams (Evidence-Based)" | https://www.youtube.com/watch?v=ukLnPbIffxE | Free | The most practical evidence-based study video. Why passive revision fails and what to do instead. Watch Week 1. |
| Ali Abdaal — Study Channel | https://www.youtube.com/@aliabdaal | Free | Ex-Cambridge med student. General, but study-technique videos apply directly. |
| Thomas Frank — Crash Course Study Skills | https://www.youtube.com/playlist?list=PL8dPuuaLjXtNcAJRf3bE1IJU6nMfHj86W | Free | 10-episode series, 10 min each. Watch the active recall and spaced repetition episodes first. |
| Save My Exams — "IGCSE Exam Tips: How to Study Smarter" | https://www.youtube.com/watch?v=_4vwPtix4GQ | Free | Recent (Mar 2026) IGCSE-specific study strategy. Practical and syllabus-aware. |

---

## YouTube — Physics (0625)
...
## YouTube — International Mathematics (0607)
...
## YouTube — English Language (0500) & Literature (0475)
...
| Resource | URL | Access | Notes |
|---|---|---|---|
| GCSE French Revision (50 Days playlist) | https://www.youtube.com/playlist?list=PLzkNigcQQXMM7NuHWgjqbPEVCvjT4qsr- | Free | 50 videos across all four skills. Directly addresses IGCSE French format. |
| How to Revise for French Listening | https://www.youtube.com/watch?v=AS3kdSoJGQo | Free | Honest listening-resource advice; practical for Paper 1. |
| How to Get a 9 in GCSE French | https://www.youtube.com/watch?v=TvEvN6Ojgi4 | Free | Effective French revision across writing, speaking, listening, reading. |
| BBC Languages French | https://www.bbc.co.uk/languages/french/ | Free | Grammar reference and listening practice. Not IGCSE-specific but aligns well. |
| Duolingo | https://www.duolingo.com/ | Freemium | Vocabulary supplement and daily habit — not sufficient alone, good for keeping French active. |

---

## YouTube — Business (0450)
...
## YouTube — Psychology (0980)

| Resource | URL | Access | Notes |
|---|---|---|---|
| Search: "IGCSE Psychology 0980 [core study]" | https://www.youtube.com/ | Free | No single dedicated 0980 channel at top quality. Search by core study name (e.g. "Milgram obedience IGCSE"). |
| Psych Boost | https://www.youtube.com/@psychboost | Free | Clear explanations of studies that appear in 0980. Not IGCSE-specific but maps well. |
| Simply Psychology (site) | https://www.simplypsychology.org/ | Free | Detailed articles on every core study. Use with the syllabus: method, sample, findings, evaluation. |
...
| Resource | URL | Access | Subjects | Notes |
|---|---|---|---|---|
| r/IGCSE Megathread (Resources) | https://www.reddit.com/r/igcse/comments/resource_megathread | Free | All subjects | Pinned community-curated resources per subject. Updated by students who've sat the exams. |
| Ali Abdaal — "The Ultimate Guide to Studying for Exams" | https://aliabdaal.com/studying/the-ultimate-guide-to-studying-for-exams/ | Free | All subjects | Long-form article behind the video series. Evidence for each technique. Read once at the start of Grade 9. |
| Simply Psychology | https://www.simplypsychology.org/ | Free | Psychology (0980) | Best free written resource for IGCSE Psychology. Articles on every major 0980 study. |
| Dinesh Bakshi — Economics Notes | https://dineshbakshi.com/igcse-gcse-economics | Free | Economics (0455) | Full syllabus coverage: notes, quizzes, worksheets, case studies. |
| Dinesh Bakshi — Business Notes | https://dineshbakshi.com/igcse-business-studies | Free | Business (0450) | Every unit of 0450 with notes and practice materials. |
...
| Resource | URL | Access | Notes |
|---|---|---|---|
| Anki | https://apps.ankiweb.net/ | Free | Gold standard for spaced repetition. Desktop + Android free; iOS paid. Make cards for keyword-bank terms and core studies. |
| Quizlet | https://quizlet.com/ | Freemium | Easier than Anki. Many pre-made IGCSE decks. Free tier substantial; paid adds study modes. |
